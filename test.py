...
keywords = "Hire software developers"
topics_n = 3
language = "english"
...
write_article_system_prompt = '''
    ...
    <a href='URL'> for external links, and utilize, if makes sense, unordered lists (<ul>) with list items (<li>) to organize information effectively. Please be sure this is well formated using utf-8.
